...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/bitcoinfile/bitcoinfile.git
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/bitcoinfile/bitcoinfile/releases/new) with a link to the archived release notes.
