...
public:
    CMainParams() {
		...
		consensus.m_iBIFIForkHeight = 501225;
       
		consensus.powLimit			=  uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		consensus.pow501225			=  uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		consensus.powLimitBIFIIndex	=  uint256S("008fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		consensus.powLimitBIFI		=  uint256S("000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
		consensus.nPowTargetTimespan   = (7 * 24 * 60 * 60); // one weeks
		consensus.nPowTargetSpacing    = (5 * 60);
		consensus.nBifiDifficultyAdjustmentInterval = 144;
        ...
        consensus.hashGenesisBlock = genesis.GetHashImp();
        ...
        //vSeeds.emplace_back("seed.btc.petertodd.org", true); // Peter Todd, only supports x1, x5, x9, and xd
 		...
 		vSeeds.emplace_back("dnsseed1.bitcoinfile.org", true); 
 		vSeeds.emplace_back("dnsseed2.bitcoinfile.org", true); 
 		vSeeds.emplace_back("dnsseed3.bitcoinfile.org", true); 
