#ifndef H_CRYPTONIGHT_H
#define H_CRYPTONIGHT_H
...
#ifndef ROTL32TZ
    #if __CUDA_ARCH__ < 350 
        #define ROTL32TZ(x, n) T32(((x) << (n)) | ((x) >> (32 - (n))))
    #else
        #define ROTL32TZ(x, n) __funnelshift_l( (x), (x), (n) )
    #endif
#endif

#ifndef ROTR32TZ
    #if __CUDA_ARCH__ < 350 
        #define ROTR32TZ(x, n) (((x) >> (n)) | ((x) << (32 - (n))))
    #else
        #define ROTR32TZ(x, n) __funnelshift_r( (x), (x), (n) )
    #endif
#endif
